...
public class Tips implements TipsDdataBaseHelper.TableCreateInterface {
    ...
    public static String location="location";//定位
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql= String.format("CREATE TABLE %s(_id integer primary key autoincrement,%s TEXT,%s TEXT,%s TEXT);", Tips.tablename, Tips.location, Tips.content, Tips.time);
    ...
    public void deleteTip(TipsDdataBaseHelper dbHelper, int _id){
        ...
        //db.query(Tips.tablename,null, null, null, null, null, "id desc");
        db.close();
    }
    //删除所有tips
    ...
    public HashMap<String,Object> getTip(TipsDdataBaseHelper dbHelper,int _id){
        ...
        cursor.moveToFirst();
        TipMap.put(Tips.location, cursor.getString(cursor.getColumnIndex(Tips.location)));
